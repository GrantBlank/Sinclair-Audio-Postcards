...
$.fn.folio = function(input) {
	...
	$('body').prepend('<div id="floating-folio"><a href="http://www.gpb.org" target="_blank" class="logoB"></a><div id="folio-info"><h2 class="small ral fat upper" style="position: relative; top: 10px; display: inline-block"><pre id="folio-title"></pre></h2></div><div class="clearfix"></div></div>')
...
$.fn.simpleFooter = function(input) {
	...
	$(this).append('<div class="footer-list ral upper fat xsmall" id="current"><a href="http://gpb.org" target="_blank" class="logoB-tiny"></a></nav>');
